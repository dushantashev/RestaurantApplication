...
//
//    public DeleteDishServlet(SpringTemplateEngine springTemplateEngine, DishService dishService, ChefService chefService) {
...
//
//        chefService.deleteDishFromChef(chefIdLong, dishId);
